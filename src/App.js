...
function App() {
  ...
  return (
    ...
    <Navbar bg="dark" data-bs-theme="dark">
        <Container style={{backgroundColor:"black"}}>
          ...
          <Nav className="me-auto">
            <Nav.Link href="#app">Liste</Nav.Link>
    ...
    <ListMovie movies={movies.filter((movie)=> movie.Title.toLocaleUpperCase().includes(searchMovie.toLocaleUpperCase().trim()) && movie.imdbRating>=searchRating)} />
